<?php
/**
 * Plugin Name: Restaurant Menu and Food Ordering
 * Plugin URI: https://www.fivestarplugins.com/plugins/five-star-restaurant-menu/
 * Description: Restaurant menu and food ordering system that is easy to set up and includes blocks, patterns and shortcodes for integration with any theme.
 * Version: 2.4.15
...
class fdmFoodAndDrinkMenu {
	...
	public function __construct() {
		...
		// Retrieve menu style setting value
		$this->menu_prostyle_value = $this->settings->get_setting('fdm-pro-style');
